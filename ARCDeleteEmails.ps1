...
Get-Mailbox -identity brent.basbagill@arcind.com | Search-Mailbox -searchQuery 'Received:01/01/1990..12/31/2017 OR Sent:01/01/1990..12/31/2017' -deletecontent | Export-CSV -Path "$PSScriptRoot\DateQuery_$currentdate.csv"